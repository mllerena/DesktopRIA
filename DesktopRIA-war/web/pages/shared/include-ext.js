...
(function() {
    ...
    document.write('<script type="text/javascript" src="' + path + '/resources/js/ext-all' + (rtl ? '-rtl' : '') + '-debug.js"></script>');
    ...
    if (neptune) {
        ...
        neptunePath = (repoDevMode ? path + '/..' : path) +
            '/pages/packages/ext-theme-neptune/build/ext-theme-neptune' +
            (repoDevMode ? '-dev' : '') + '.js';
        ...
        if (repoDevMode &&  window.ActiveXObject) {
            ...
            //console.log("neptunePath - "+neptunePath);
